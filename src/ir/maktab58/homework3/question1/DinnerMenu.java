...
public class DinnerMenu extends Menu{
    ...
    public void addNewDrink(String name, int price, int count) {
        for (int i = 0; i < drinks.length; i++){
            if (name.equals(drinks[i].getItemName())){
                ...
                System.out.println("count of " + name + " in dinner menu has updated.");
                return;
            }
        }
        ...
        drinks = newDrinks;
        drinksId++;
        System.out.println("New drink has been added in dinner menu.");
    }
    ...
    public void addNewFood(String name, int price, int count) {
        ...
        foods = newFoods;
        foodsId++;
        System.out.println("New food has been added in dinner menu.");
    }
